    ...
    public partial class frmConsulta : MetroForm
    {
                    ...
                    case "aluno":
                        {
                            ...
                            else
                            {
                                ...
                                frm.txtNomeSocial.Text = dgvDados.SelectedRows[0].Cells[2].Value.ToString();

                                //propriedades Checked recebem Value convertido para booleano
                                frm.chkPAE.Checked = Convert.ToBoolean(dgvDados.SelectedRows[0].Cells[3].Value);

                                //text
                                frm.txtNaturalidade.Text = dgvDados.SelectedRows[0].Cells[4].Value.ToString();
                                frm.mskRG.Text = dgvDados.SelectedRows[0].Cells[5].Value.ToString();
                                frm.mskCPF.Text = dgvDados.SelectedRows[0].Cells[6].Value.ToString();

                                //propriedades SelectedItem recebem Value
                                frm.cmbUF.SelectedItem = dgvDados.SelectedRows[0].Cells[7].Value;
                                frm.cmbEstadoCivil.SelectedItem = dgvDados.SelectedRows[0].Cells[8].Value;
                                frm.cmbSexo.SelectedItem = dgvDados.SelectedRows[0].Cells[9].Value;
                                

                                //text
                                frm.txtNomePai.Text = dgvDados.SelectedRows[0].Cells[10].Value.ToString();
                                frm.txtNomeMae.Text = dgvDados.SelectedRows[0].Cells[11].Value.ToString();
                                frm.txtEndereco.Text = dgvDados.SelectedRows[0].Cells[12].Value.ToString();
                                frm.txtBairro.Text = dgvDados.SelectedRows[0].Cells[13].Value.ToString();
                                frm.mskCEP.Text = dgvDados.SelectedRows[0].Cells[14].Value.ToString();
                                frm.mskTelefoneFixo.Text = dgvDados.SelectedRows[0].Cells[15].Value.ToString();
                                frm.mskCelular.Text = dgvDados.SelectedRows[0].Cells[16].Value.ToString();
                                frm.txtEmail.Text = dgvDados.SelectedRows[0].Cells[17].Value.ToString();


                                _CaminhoFoto = dgvDados.SelectedRows[0].Cells[20].Value.ToString();

                                //text
                                frm.txtIdade.Text = dgvDados.SelectedRows[0].Cells[21].Value.ToString();
                                frm.mskDataNascimento.Text = dgvDados.SelectedRows[0].Cells[22].Value.ToString();

                                //checked
                                frm.chkRepetente.Checked = Convert.ToBoolean(dgvDados.SelectedRows[0].Cells[24].Value.ToString());
                                ...
                                frm.cmbCurso.SelectedItem = dgvDados.SelectedRows[0].Cells[18].Value;
                                frm.cmbTurma.SelectedItem = dgvDados.SelectedRows[0].Cells[19].Value;
                    ...
                    case "encaminhamento":
                        {
                            ...
                            else
                            {
                                ...
                                frm.cmbDiaSemana.SelectedItem = dgvDados.SelectedRows[0].Cells[7].Value;
                                frm.cmbTurno.SelectedItem = dgvDados.SelectedRows[0].Cells[8].Value;
            ...
            try
            {
                switch (Consulta)
                {
                    ...
                    case "aluno":
                        ...
                        dgvDados.Columns[2].HeaderText = "Nome Social";
                        dgvDados.Columns[3].HeaderText = "Utiliza o PAE?";
                        dgvDados.Columns[4].HeaderText = "Naturalidade";
                        dgvDados.Columns[5].HeaderText = "RG";
                        dgvDados.Columns[6].HeaderText = "CPF";
                        dgvDados.Columns[7].HeaderText = "UF";
                        dgvDados.Columns[8].HeaderText = "Estado Cívil";
                        dgvDados.Columns[9].HeaderText = "Sexo";
                        dgvDados.Columns[10].HeaderText = "Nome do pai";
                        dgvDados.Columns[11].HeaderText = "Nome da mãe";
                        dgvDados.Columns[12].HeaderText = "Endereço";
                        dgvDados.Columns[13].HeaderText = "Bairro";
                        dgvDados.Columns[14].HeaderText = "CEP";
                        dgvDados.Columns[15].HeaderText = "Telefone Fixo";
                        dgvDados.Columns[16].HeaderText = "Celular";
                        dgvDados.Columns[17].HeaderText = "Email";
                        dgvDados.Columns[18].HeaderText = "Curso";
                        dgvDados.Columns[19].HeaderText = "Turma";
                        dgvDados.Columns[20].HeaderText = "Caminho da foto";
                        dgvDados.Columns[21].HeaderText = "Idade";
                        dgvDados.Columns[22].HeaderText = "Data de Nascimento";
                        dgvDados.Columns[23].HeaderText = "Data de Cadastro";
                        dgvDados.Columns[24].HeaderText = "É repetente?";
                        dgvDados.Columns[25].HeaderText = "ID Turma";
                        dgvDados.Columns[26].HeaderText = "ID Login";
        ...
        private void GerarPDF(string nomeArquivo)
        {
            try
            {
                ...
                var fonteRodapé = iTextSharp.text.FontFactory.GetFont("Arial", 7);
                string Rodapé = "\n \n \n \n \n \n \n \n \n \n \n \n CAMPUS SALTO - Rua Rio Branco,nº.1780 - Vila Teixeira - Salto/SP \n"
                + "CNPJ:10.882.594/0012-18 \n " + "Telefone:(11)4602-9194  Fax:(11)4602-9192";
                Paragraph rodapé = new Paragraph(Rodapé, fonteRodapé);
                rodapé.Alignment = iTextSharp.text.Element.ALIGN_CENTER;

                #endregion

                #region Imagem
                System.Drawing.Image img = System.Drawing.Image.FromFile(@"cabecalho.png");
                Bitmap bit = new Bitmap(img, new Size(200, 100));
                iTextSharp.text.Image pic = iTextSharp.text.Image.GetInstance(bit, System.Drawing.Imaging.ImageFormat.Jpeg);
                documento.Add(pic);
                #endregion
                ...
                switch (_Consulta)
                {
                    case "aluno":
                        {
                            var fontePrincipal = iTextSharp.text.FontFactory.GetFont("Arial", 10);
                            #region Dados Pessoais
                            ...
                            string dadosPessoais = "\nNome : " + dgvDados.SelectedRows[0].Cells[1].Value.ToString() +
                                                   ...
                                                   "\nData de nascimento: " + dgvDados.SelectedRows[0].Cells[22].Value.ToString() + 
                                                   "\nIdade: " + dgvDados.SelectedRows[0].Cells[21].Value.ToString() + 
                                                   "\nNaturalidade: " + dgvDados.SelectedRows[0].Cells[4].Value.ToString() + 
                                                   "\nEstado: " + dgvDados.SelectedRows[0].Cells[7].Value.ToString() + 
                                                   "\nEstado civil: " + dgvDados.SelectedRows[0].Cells[8].Value.ToString() + 
                                                   "\nSexo: " + dgvDados.SelectedRows[0].Cells[9].Value.ToString() + 
                                                   "\nNome do pai: " + dgvDados.SelectedRows[0].Cells[10].Value.ToString() + 
                                                   "\nNome da mãe: " + dgvDados.SelectedRows[0].Cells[11].Value.ToString();

                            Paragraph pessoais = new Paragraph(dadosPessoais, fontePrincipal);

                            #endregion

                            #region Dados de contato

                            string dadosContato = "\nEndereço: " + dgvDados.SelectedRows[0].Cells[12].Value.ToString() +
                                                  "\nBairro: " + dgvDados.SelectedRows[0].Cells[13].Value.ToString() +
                                                  "\nCEP: " + dgvDados.SelectedRows[0].Cells[14].Value.ToString() +
                                                  "\nTelefone Fixo" + dgvDados.SelectedRows[0].Cells[15].Value.ToString() +
                                                  "\nCelular: " + dgvDados.SelectedRows[0].Cells[16].Value.ToString() +
                                                  "\nEmail: " + dgvDados.SelectedRows[0].Cells[17].Value.ToString();

                            Paragraph contato = new Paragraph(dadosContato, fontePrincipal);
                            ...
                            string dadosEscolares = "\nProntuário: " + dgvDados.SelectedRows[0].Cells[0].Value.ToString() +
                                                    "\nCurso: " + dgvDados.SelectedRows[0].Cells[18].Value.ToString() +
                                                    "\nTurma: " + dgvDados.SelectedRows[0].Cells[19].Value.ToString() +
                                                    "\nData de Cadastro: " + dgvDados.SelectedRows[0].Cells[23].Value.ToString();
                            ...
                            Paragraph escolares = new Paragraph(dadosEscolares, fontePrincipal);

                            #endregion

                            #region Titulo

                            var fonte = iTextSharp.text.FontFactory.GetFont("Calibri", 20);
                            string Titulo = "Ficha do Aluno";
                            Paragraph titulo = new Paragraph(Titulo, fonte);
                            titulo.Alignment = iTextSharp.text.Element.ALIGN_CENTER;

                            #endregion

                            #region cabeçalho
                            var fonteCabeçalho = iTextSharp.text.FontFactory.GetFont("Calibri Light", 9);
                            string cabecalho = "INSTITUITO FEDERAL DE EDUCAÇÃO,CIÊCIA E TECNOLOGIA DE SÃOPAULO CAMPUS SALTO COORDENADORA SOCIOPEDAGÓGICA";
                            Paragraph Cabecalho = new Paragraph(cabecalho, fonteCabeçalho);
                            #endregion
                    ...
                    case "emissao":
                        {
                            ...
                            string dadosParticipantes = "\nNome do Aluno : " + dgvDados.SelectedRows[0].Cells[1].Value.ToString() +
                            ...
                            string dadosRelato = "\n\n\nRelato : " + dgvDados.SelectedRows[0].Cells[3].Value.ToString();
                    ...
                    case "funcionario":
                        {
                            ...
                            var fonte = iTextSharp.text.FontFactory.GetFont("Calibri", 20);
                            string titulo = "Ficha do Funcionario";
                            Paragraph Titulo = new Paragraph(titulo, fonte);
                            Titulo.Alignment = iTextSharp.text.Element.ALIGN_CENTER;
