...
namespace SGSP___Desktop
{
    ...
    class Aluno : Pessoa
    {
        ...
        string _NomeMae, _NomePai, _Curso, _Turma, _NomeSocial;
        ...
        public Aluno(string nome, string rg, string cpf, string naturalidade, string uf, 
                     ...
                     DateTime? dataCadastro, bool pae, bool repetente, string nomesocial)
        {
            _Nome = nome;
            _Rg = rg;
            _Cpf = cpf;
        ...
        public override string Insere()
        {
            try
            {
                string sql = "INSERT INTO ALUNO (NOME, RG, CPF, NATURALIDADE, UF, ESTADO_CIVIL, SEXO, " +
                                                ...
                                                "DATA_CADASTRO, PAE, REPETENTE, ID_TURMA, NOME_SOCIAL) " +
                ...
                cmd.Parameters.AddWithValue("@NOME_SOCIAL", _NomeSocial);
        ...
        public override string Altera()
        {
            try
            {
                string sql = "UPDATE ALUNO " +
                             ...
                             "WHERE PRONTUARIO = @PRONTUARIO";                //parâmetro do código do aluno
